...
/// Szablon funkcji zwracającej wartość bezwzględną
template<typename TYP>
TYP Abs(TYP v) {
	if(v<0) return -v; return v;
}

/// Szablon funkcji zwracającej wartość maksymalną
template<typename TYP>
TYP Max(TYP a,TYP b) {
	if(a<b) return b; return a;
}

/// Szablon funkcji zwracającej wartość minimalną
template<typename TYP>
TYP Min(TYP a,TYP b) {
	if(a<b) return a; return b;
}

/// funkcja konwertuje wartosc całkowitą na string
...
/// funkcja konwertuje wartosc zmiennoprzecinkową na string
