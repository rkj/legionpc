...
public:
	...
	bool GetBool(void)	{
		ASSERT( type == TP_BOOL, "ALAN: Próba pobrania wartości typu BOOL, a wartość jest innego typu" );
		return val.v_bool;
	}
	int GetInt(void)	{
		ASSERT( type == TP_INT, "ALAN: Próba pobrania wartości typu INT, a wartość jest innego typu" );
		return val.v_int;
	}
	float GetFloat(void)	{
		ASSERT( type == TP_FLOAT, "ALAN: Próba pobrania wartości typu FLOAT, a wartość jest innego typu" );
		return val.v_float;
	}
	const std::string& GetString(void)	{
		ASSERT( type == TP_STRING, "ALAN: Próba pobrania wartości typu STRING, a wartość jest innego typu" );
		return v_str;
	}
...
public:
	...
	~AlanFuncStrLen()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( str->type == TP_STRING, "ALAN: Parametr 'str' funkcji STRLEN jest innego typu niż STRING" );
...
public:
	...
	~AlanFuncSubStr()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( str->type == TP_STRING, "ALAN: Parametr 'str' funkcji SUBSTR jest innego typu niż STRING" );
		ASSERT( beg->type == TP_INT, "ALAN: Parametr 'beg' funkcji SUBSTR jest innego typu niż INT" );
		ASSERT( cnt->type == TP_INT, "ALAN: Parametr 'cnt' funkcji SUBSTR jest innego typu niż INT" );
		int b,c;
		std::string s;
...
public:
	...
	~AlanFuncInStr()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( str->type == TP_STRING, "ALAN: Parametr 'str' funkcji INSTR jest innego typu niż STRING" );
		ASSERT( pat->type == TP_STRING, "ALAN: Parametr 'pat' funkcji INSTR jest innego typu niż STRING" );
		ASSERT( beg->type == TP_INT, "ALAN: Parametr 'beg' funkcji SUBSTR jest innego typu niż INT" );
		int b,i;
		std::string s,p;
		s = str->Eval(state).GetString();
...
public:
	...
	~AlanFuncRandI()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( p1->type == TP_INT, "ALAN: Parametr nr 1 funkcji RAND jest innego typu niż INT" );
		ASSERT( p2->type == TP_INT, "ALAN: Parametr nr 2 funkcji RAND jest innego typu niż INT" );
		int low,hi;
...
public:
	...
	~AlanFuncRandF()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( p1->type == TP_FLOAT, "ALAN: Parametr nr 1 funkcji RANDF jest innego typu niż FLOAT" );
		ASSERT( p2->type == TP_FLOAT, "ALAN: Parametr nr 2 funkcji RANDF jest innego typu niż FLOAT" );
		float low,hi;
...
public:
	...
	~AlanFuncSin()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( par->type == TP_FLOAT, "ALAN: Parametr funkcji SIN jest innego typu niż FLOAT" );
		float p;
...
public:
	...
	~AlanFuncCos()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( par->type == TP_FLOAT, "ALAN: Parametr funkcji COS jest innego typu niż FLOAT" );
		float p;
		p = par->Eval(state).GetFloat();
...
public:
	...
	~AlanFuncTan()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( par->type == TP_FLOAT, "ALAN: Parametr funkcji TAN jest innego typu niż FLOAT" );
		float p;
		p = par->Eval(state).GetFloat();
...
public:
	...
	~AlanFuncExp()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( par->type == TP_FLOAT, "ALAN: Parametr funkcji EXP jest innego typu niż FLOAT" );
		float p;
		p = par->Eval(state).GetFloat();
...
public:
	...
	~AlanFuncLog()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( par->type == TP_FLOAT, "ALAN: Parametr funkcji LOG jest innego typu niż FLOAT" );
		float p;
		p = par->Eval(state).GetFloat();
...
public:
	...
	~AlanFuncPow()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( p1->type == TP_FLOAT, "ALAN: Parametr nr 1 funkcji POW jest innego typu niż FLOAT" );
		ASSERT( p2->type == TP_FLOAT, "ALAN: Parametr nr 2 funkcji POW jest innego typu niż FLOAT" );
		float v1,v2;
...
public:
	...
	~AlanFuncSqrt()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( par->type == TP_FLOAT, "ALAN: Parametr funkcji SQRT jest innego typu niż FLOAT" );
		float p;
		p = par->Eval(state).GetFloat();
...
public:
	...
	~AlanFuncAbsI()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( par->type == TP_INT, "ALAN: Parametr funkcji ABS_I jest innego typu niż INT" );
		int p;
...
public:
	...
	~AlanFuncAbsF()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( par->type == TP_INT, "ALAN: Parametr funkcji ABS_F jest innego typu niż FLOAT" );
		float p;
		p = par->Eval(state).GetFloat();
...
public:
	...
	~AlanFuncSgnI()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( par->type == TP_INT, "ALAN: Parametr funkcji SGN_I jest innego typu niż INT" );
		int p;
		p = par->Eval(state).GetInt();
...
public:
	...
	~AlanFuncSgnF()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( par->type == TP_INT, "ALAN: Parametr funkcji SGN_F jest innego typu niż FLOAT" );
		float p;
		p = par->Eval(state).GetFloat();
...
public:
	...
	~AlanFuncFloor()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( par->type == TP_FLOAT, "ALAN: Parametr funkcji FLOOR jest innego typu niż FLOAT" );
		float p;
		p = par->Eval(state).GetFloat();
...
public:
	...
	~AlanFuncCeil()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( par->type == TP_FLOAT, "ALAN: Parametr funkcji CEIL jest innego typu niż FLOAT" );
		float p;
		p = par->Eval(state).GetFloat();
...
public:
	...
	~AlanFuncMinF()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( p1->type == TP_FLOAT, "ALAN: Parametr nr 1 funkcji MIN_F jest innego typu niż FLOAT" );
		ASSERT( p2->type == TP_FLOAT, "ALAN: Parametr nr 2 funkcji MIN_F jest innego typu niż FLOAT" );
		float v1,v2;
		v1 = p1->Eval(state).GetFloat();
		v2 = p2->Eval(state).GetFloat();
...
public:
	...
	~AlanFuncMinI()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( p1->type == TP_INT, "ALAN: Parametr nr 1 funkcji MIN_I jest innego typu niż INT" );
		ASSERT( p2->type == TP_INT, "ALAN: Parametr nr 2 funkcji MIN_I jest innego typu niż INT" );
		int v1,v2;
...
public:
	...
	~AlanFuncMaxF()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( p1->type == TP_FLOAT, "ALAN: Parametr nr 1 funkcji MAX_F jest innego typu niż FLOAT" );
		ASSERT( p2->type == TP_FLOAT, "ALAN: Parametr nr 2 funkcji MAX_F jest innego typu niż FLOAT" );
		float v1,v2;
		v1 = p1->Eval(state).GetFloat();
		v2 = p2->Eval(state).GetFloat();
		return AlanValue( v1>v2 ? v1 : v2 );
...
public:
	...
	~AlanFuncMaxI()	{}
	AlanValue Eval(AlanState *state) {
		ASSERT( p1->type == TP_INT, "ALAN: Parametr nr 1 funkcji MAX_I jest innego typu niż INT" );
		ASSERT( p2->type == TP_INT, "ALAN: Parametr nr 2 funkcji MAX_I jest innego typu niż INT" );
		int v1,v2;
		v1 = p1->Eval(state).GetInt();
		v2 = p2->Eval(state).GetInt();
		return AlanValue( v1>v2 ? v1 : v2 );
...
public:
	...
	void SetValue( const AlanValue& v ) {
		ASSERT( type == v.type, "ALAN: Próba przypisania zmiennej wartości typu innego niż BOOL" );
		val = v;
	}
...
public:
	...
	void SetValue( const AlanValue& v ) {
		ASSERT( type == v.type, "ALAN: Próba przypisania zmiennej wartości typu innego niż INT " );
		val = v;
	}
	AlanValue Eval(AlanState *state) { return val; }
};
...
public:
	...
	void SetValue( const AlanValue& v ) {
		ASSERT( type == v.type, "ALAN: Próba przypisania zmiennej wartości typu innego niż FLOAT" );
		val = v;
	}
	AlanValue Eval(AlanState *state) { return val; }
};
...
public:
	...
	void SetValue( const AlanValue& v ) {
		ASSERT( type == v.type, "ALAN: Próba przypisania zmiennej wartości typu innego niż STRING" );
		val = v;
	}
	AlanValue Eval(AlanState *state) { return val; }
};
...
public:
	...
	AlanExpr2Arg( AlanExpr *p_e1, AlanExpr *p_e2 ) : e1(p_e1), e2(p_e2) {
		ASSERT( e1->type == e2->type, "ALAN: Typy parametrów operatora dwuargumentowego nie są zgodne");
		type = e1->type;
	}
...
public:
	...
	AlanValue Eval(AlanState *state) {
		...
		v1 = e1->Eval(state);
		v2 = e2->Eval(state);
		//typy powinny się zgadzac
		ASSERT( v1.type == v2.type, "ALAN: Typy parametrów operatora + nie są zgodne");
		switch( v1.type ) {
