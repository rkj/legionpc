  ...
  astr A_S="", PO_S="";
	...
	if( TESTING==0 ) {																								//	   If Not TESTING
		MESSAGE(A,A_S,NR,0); SpriteOnOff(2,false);											//	      MESSAGE[A,A$,NR,0] : Sprite Off 2
																																		...
																																		//	   'űadnych komunikatów po akcji 0 armie lub 1 miasta
	M=-1;																															//	   M=-1
	ARM=A; WRG=40;																										//	   ARM=A : WRG=40
	...
	if( TYP==9 ) {																										//	   If TYP=9
		...
		MAIN_ACTION();																									//	      MAIN_ACTION
																																		...
																																		//
	if( TYP==10 ) {																										//	   If TYP=10
		//---barbarzyďca na bagnach---																	//	      'barbarzyďca na bagnach
	...
	if( TYP==13 ) {																										//	   If TYP=13
																																		//	      'Goto SKIP2
		//---sparing koďcowy---																					//	      'sparing koďcowy
...
//			Fade 2;																											//	         Fade 2
			...
			if( WYNIK_AKCJI==1 || IMIONA_S[1]=="Marcin ®" ) {							//	         If WYNIK_AKCJI=1 or IMIONA$(1)="Marcin ®"
				...
				OUTLINE(10,210,GS("087"),1,0);															//	            OUTLINE[10,210,"wszelkie űycie ",1,0]
				OUTLINE(10,220,GS("088"),1,0);															//	            OUTLINE[10,220,"leűy teraz martwy",1,0]
