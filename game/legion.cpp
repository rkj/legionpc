...
void ZAB(void) {
		//	Procedure ZAB
		//	   '* po upîywie 20-u rozmów do 50-u musi odpalię
		//	   'po kaűdym kliku w gadce dec bomba1 inc bomba2
		//	   'sprawdzanie bomby w mapa_akcja,ma_ruch,main_action
		//	   'wychodzenie albo endami albo editami albo pokami albo gameover=true
		//	   'wywoîywana przez co sîychaę albo przyîâcz ôie albo szmal albo samoistnie
